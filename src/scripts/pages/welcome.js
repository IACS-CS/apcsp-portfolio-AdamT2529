...
export function renderWelcome() {
  ...
  return `
    ...
    <p data-aos="fade-in">I am a student at IACS. I am taking the class of AP Computer Science Principles and this website consists of my favorite work I created in this course.</p>
