...
export function renderBinarySearch() {
  ...
  return `
    ...
    <article>
      ...
      <hr>
      <p data-aos="zoom-in">My project was super fun, I made a questionaire based on the characters from Spongebob Squarepants and the user had to answer yes or no to the questions I asked. Depending on what they answered, they would be told what Spongebob Character matches them and be shown the image of the character.</p>
      ${renderIframe(
